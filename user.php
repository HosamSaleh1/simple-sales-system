    ...
    <div class="col-6 offset-3 text-right">
      <form method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="tax_num" placeholder="من فضلك أدخل الرقم الضريبي" value="<?php if ($_POST && $fill) {
                                                                                                                    echo $_POST['tax_num'];
                                                                                                                  } ?>">
        </div>
        <div class="form-group">
          <label for="">العنوان</label>
          <input type="text" class="form-control" name="address" placeholder="من فضلك أدخل العنوان بالتفصيل" value="<?php if ($_POST && $fill) {
                                                                                                                      echo $_POST['address'];
                                                                                                                    } ?>">
        </div>
        <div class="form-group">
          <label for="">رقم الهاتف</label>
          <input type="number" class="form-control" name="phone" placeholder="من فضلك أدخل رقم التليفون" value="<?php if ($_POST && $fill) {
                                                                                                                  echo $_POST['phone'];
                                                                                                                } ?>">
        </div>
        <div class="form-group">
          <label for="">البريد الإلكتروني</label>
          <input type="email" class="form-control" name="email" placeholder="من فضلك أدخل البريد اﻹلكتروني" value="<?php if ($_POST && $fill) {
                                                                                                                      echo $_POST['email'];
                                                                                                                    } ?>">
        </div>
